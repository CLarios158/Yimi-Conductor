...
class PruebaToxicologica extends Component {
    ...
    pickImage = async () => {
        ...
        if(this.state.image != ""){
            this.props.navigation.navigate('CargarPruebaTM',{image: this.state.image, id_usuario: this.state.id_usuario, id_cat_documento:10})
        }
    };
    ...
    openCamera = () => {
        this.props.navigation.navigate('CamaraM',{image: this.state.image, id_usuario: this.state.id_usuario, id_cat_documento:10, estado: this.state.estado})
    };
