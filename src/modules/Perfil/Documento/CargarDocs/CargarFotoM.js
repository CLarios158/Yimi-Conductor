...
class Foto extends Component {
    ...
    CargarDocumento = () =>{
        axios.put('http://35.203.42.33:3000/modificar_documento',{fk_id_usuario: this.state.id_usuario, archivo: this.state.image, fk_id_cat_documento: this.state.id_cat_documento, tipo_rfc: null})
        .then(response => {
            console.log('Modifico Foto');
            this.props.navigation.navigate('DocumentoM', {id_usuario: this.state.id_usuario, estado_foto:1});
        })
