...
class CartaAntecedentesPenales extends Component {
    ...
    pickImage = async () => {
        ...
        if(this.state.image != ""){
            this.props.navigation.navigate('CargarCartaM',{image: this.state.image, id_usuario: this.state.id_usuario, id_cat_documento:8})
        }
    };
    ...
    openCamera = () => {
        this.props.navigation.navigate('CamaraM',{image: this.state.image, id_usuario: this.state.id_usuario, id_cat_documento:8, estado: this.state.estado})
    };
